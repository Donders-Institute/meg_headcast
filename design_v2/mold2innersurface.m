...
% MOLD2INNERSURFACE extracts the innersurface of the headcast mold, which
% is the object that can be aligned with the MEG dewar helmet surface. This
% latter alignment is done by the ALIGN_MOLDSTL2DEWAR function.
...
if 0
  ...
  innersurface.fid      = mold.fid;

  save(fullfile('/home/dyncon/jansch/projects/meg_headcast/models', 'mold_innersurface.mat'), 'innersurface');

else
  [mold, transform_moldstl2ctfish] = align_moldstl2ctfish;
  load(fullfile('/home/dyncon/jansch/projects/meg_headcast/models', 'mold_innersurface.mat'), 'innersurface');
  innersurface.fid = mold.fid;
end

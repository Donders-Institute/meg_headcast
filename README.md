# Making and using MEG headcasts
...
For researchers within the DCCN, please consult the standard operating procedure (SOP), which is included in this repository for reference. When using headcasts in the MEG lab of the DCCN, **always check for the latest version** of the SOP on the [DCCN intranet](https://intranet.donders.ru.nl/index.php?id=meg-lab-procedures).

- [standard operating procedure (DCCN)](labinstructions_dccn/SOP_headcast_20220818.pdf)
...
- [standard operating procedure (UCL)](labinstructions_ucl/WTCN_MEG_HEADCAST_SOP_march2015.pdf)
- [emergency procedure](labinstructions_ucl/WTCN_MEG_HEADCAST_Emerg_proc_Appendix2.pdf)
- [training checklist](labinstructions_ucl/WTCN_MEG_HEADCAST_training_Appendix1.pdf)
- [volunteer guide](labinstructions_ucl/volunteerguide_v2.pdf)
